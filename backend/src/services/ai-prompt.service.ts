...
const DEFAULT_BY_SCOPE: Record<PromptScope, string> = {
  ...
  MIEMBRO_ACTIVO:
    ...
    '[5] recordatorios de medicación, [6] citas y turnos médicos, [7] descargar Kit QR/stickers, [8] modificar datos de emergencia/alergias, [9] descargar todos mis documentos (estudios y recetas, llegan al WhatsApp), [10] soporte. ' +
